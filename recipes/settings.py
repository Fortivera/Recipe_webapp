...
# Make sure to set the value to True when in production!
...
MEDIA_URL = 'media/'
DEFAULT_FILE_STORAGE = 'recipes.storages.MediaStorage' 
 

# this is for development environment, ACTIVATE WHEN YOU ARE LOCAL only:
